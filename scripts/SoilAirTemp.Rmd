...
(plot_russia =  ggplot(data = soilEastLat1, aes(x=doy_st, y=mean_soil_t, color=as.factor(st_depth)))  +
  geom_line() +
...
(plot_canada1 =  ggplot(data = soilWestLat1, aes(x=doy_st, y=mean_soil_t, color=as.factor(st_depth)))  +
  geom_line() +
...
(plot_AK =  ggplot(data = soilWestLat4, aes(x=doy_st, y=mean_soil_t, color=as.factor(st_depth)))  +
  geom_line() +
...
# Combine
```{r}
cowplot::plot_grid(plot_russia, plot_canada1)
```