...
```{r}
f3_thaw_pts = st_as_sf(f3_thaw, coords = c("long","lat"), crs = 4326, remove = FALSE)
```
...
st_write(f3_thaw_pts, "../outputs/ThawPoints/Buma_thaw_pts.shp", driver="ESRI Shapefile")
```
