...
```{r}
f1_thaw_pts = st_as_sf(f1_thaw, coords = c("long","lat"), crs = 4326, remove = FALSE)
```


### write to shapefile
```{r eval=FALSE, include=FALSE}
st_write(f1_thaw_pts, "../outputs/ThawPoints/Baillargeon_thaw_pts.shp", driver="ESRI Shapefile")
```
