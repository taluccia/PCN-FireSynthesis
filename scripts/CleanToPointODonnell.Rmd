...
# Save clean data
```{r}
write_csv(f11_active, "../outputs/CleanActive/ODonnellCleanActive.csv")
```
...
### write to shapefile
```{r}
st_write(f11_active_pts, "../outputs/ActivePoints/ODonnell_thaw_pts.shp", driver="ESRI Shapefile")
st_write(f11_thaw_pts, "../outputs/ThawPoints/ODonnell_thaw_pts.shp", driver="ESRI Shapefile")
