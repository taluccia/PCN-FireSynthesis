...
```{r}
f13_dates %>% distinct(site_id, plot_id, fire_id, burn_unburn) %>% write.csv(., '../outputs/pairs/rocha.csv')
```
...
st_write(f13_pts, "../outputs/allPoints/Rocha_pts.shp", driver="ESRI Shapefile")
```
