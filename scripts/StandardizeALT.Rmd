...
## Individual files
```{r}
f2001 <- read_csv(f[18]) %>% filter(thw_ctv=="thaw") %>% mutate(altDate=minDate-14)
f2005 <- read_csv(f[19]) %>% filter(thw_ctv=="thaw") %>% mutate(altDate=minDate-14)
f2006 <- read_csv(f[20]) %>% filter(thw_ctv=="thaw") %>% mutate(altDate=minDate-14) 
f2007 <- read_csv(f[21]) %>% filter(thw_ctv=="thaw") %>% mutate(altDate=minDate-14) 
f2008 <- read_csv(f[22]) %>% filter(thw_ctv=="thaw") %>% mutate(altDate=minDate-14) 
f2009 <- read_csv(f[23]) %>% filter(thw_ctv=="thaw") %>% mutate(altDate=minDate-14) 
f2010 <- read_csv(f[24]) %>% filter(thw_ctv=="thaw") %>% mutate(altDate=minDate-14) 
f2011 <- read_csv(f[25]) %>% filter(thw_ctv=="thaw") %>% mutate(altDate=minDate-14) 
f2012 <- read_csv(f[26]) %>% filter(thw_ctv=="thaw") %>% mutate(altDate=minDate-14)
f2013 <- read_csv(f[27]) %>% filter(thw_ctv=="thaw") %>% mutate(altDate=minDate-14)
f2014 <- read_csv(f[28]) %>% filter(thw_ctv=="thaw") %>% mutate(altDate=minDate-14)
f2015 <- read_csv(f[29]) %>% filter(thw_ctv=="thaw") %>% mutate(altDate=minDate-14)
f2016 <- read_csv(f[30]) %>% filter(thw_ctv=="thaw") %>% mutate(altDate=minDate-14) 
f2017 <- read_csv(f[31]) %>% filter(thw_ctv=="thaw") %>% mutate(altDate=minDate-14)
f2018 <- read_csv(f[32]) %>% filter(thw_ctv=="thaw") %>% mutate(altDate=minDate-14) 
f2019 <- read_csv(f[33]) %>% filter(thw_ctv=="thaw") %>% mutate(altDate=minDate-14)
f2020 <- read_csv(f[34]) %>% filter(thw_ctv=="thaw") %>% mutate(altDate=minDate-14)
```
...
n2001 = f2001 %>% group_by(id) %>% nest() %>%
( calc_2001 = n2001 %>% mutate(A_calc = map(calc_A))  %>% mutate(B_calc = map(calc_B)) ) 
```
